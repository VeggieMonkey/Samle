...
english.WelcomeLabel2=This will install {#AppName} {#AppVersion} on your computer.%n%nThis tool adds a right-click context menu entry to Windows Explorer so you can merge PDF files with a single click.%n%nNote: On Windows 11, the entry appears under "Show more options".%n%nClick Next to continue.

norwegian.WelcomeLabel1=Velkommen til installasjonsveiledningen for {#AppName}
norwegian.WelcomeLabel2=Dette vil installere {#AppName} {#AppVersion} på datamaskinen din.%n%nVerktøyet legger til et høyreklikk-menyvalg i Windows Utforsker slik at du kan slå sammen PDF-filer med ett klikk.%n%nMerk: På Windows 11 finner du valget under «Vis flere alternativer».%n%nKlikk Neste for å fortsette.
